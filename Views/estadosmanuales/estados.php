...
<style>
	...
	<?php
		...
		Elementos::StartFormFile('12', 'https://sispo.intranetflash.com/api/flame/ApisExternas/AjaxEstadosGenericos.php');
		//https://sispo.com.ar/clienteflash/XMLHttpRequest/EstadosManuales/AjaxEstadoManual.php
		//https://sispo.intranetflash.com/api/flame/ApisExternas/AjaxEstadosGenericos.php
		...
		Elementos::CrearImput("Hdr","text","Hoja de Ruta","4",$Extra = false);
		Elementos::CrearSelectt("EstadoDeLaPieza","Estado De La Pieza","12");
	...
	<?php
		...
		Elementos::StartFormFile('12', 'https://sispo.com.ar/clienteflash/XMLHttpRequest/EstadosManuales/AjaxEditarEstadoManual.php');//../XMLHttpRequest/EstadosManuales/AjaxEditarEstadoManual.php
...
<input type="text" name="Hdr" id="Hdr" style="display:none;">
