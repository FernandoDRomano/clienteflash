...
?>
	<style>
       ...
       * element that contains the map. */
	    ...
	    #DivContenedorEcxelATabla:hover {
	        box-sizing: border-box;
	        box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, .25) !important;
	    }

	    #DivContenedorEcxelATabla:focus {
	        box-sizing: border-box;
	        box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, .25) !important;
	    }
	</style>
	...
	<P id="TempImgNull" height="auto" hidden></P>
	                ...
	                <div class="container-fluid">
	                    ...
	                    <div class="row justify-content-between">
	                        <button type="button" class="btn btn-secondary mb-3 mb-lg-0" id="SalirDeModal" data-dismiss="modal">
	                            Volver A Edición De Carta Documento
	                        </button>
	                        <button type="button" class="btn btn-primary" id="SalirDeModal" onclick="validarEnvioCartaDocumento()">
	            ...
	            <div class="card-body">
	                ...
	                <div class="row">
	                    ...
	                    <div class="col-12">
                            ...
                            $Config->ErrorDeLectura = "<b style='text-align: center;'><p>Este Documento No Contiene Datos O Son ilegibles Intente:</P><p>Seleccionando Plantilla, Descargar Desde El Icono<img src='../xlsx-512.png' alt='Documento Base' width='26px'> Y Completando Almenos 1 Fila Con Datos</p><p>O Comuniquese Con Un (Ejecutivo de cuentas) en:</p><center><a target='_blank' href='http://correoflash.com/contacto'>Contacto CorreoFlash Pagina Oficial</a></center>.</b>";
                            Elementos::CrearInputUploadExelATabla("EcxelATabla", "ListadoDeArchivos", "Destinatario", "12", "Destinatario,Domicilio,CodigoPostal,Localidad,Barra", json_encode($Config));

                            $Config->DivContenedor = "DivDestinatario";
                            $Config->ConFiltro = true;
                            $Config->CrearAlCargarDatos = true;
                            echo ('<hr class="size2 hideline">');
                            //Elementos::CrearTabladashboard("Destinatario","12","Datos De Destinatario","",false,10,"display: none","display: none",false,"border: 2px solid #0068a9;");
                            Elementos::CrearTabladashboard("Destinatario", "12", "Datos De Destinatario", "", false, 3, "", "", false, "border: 2px solid #0068a9;display: none;"); //
                            ?>
	                    </div>
	...
	<script>
	    ...
	    function validarVistaPrevia() {
	        if (validar()) {
	            console.log("paso validación de vista previa")
	            VistaPreviaPDF('textBox')
	            console.log("se ejecuto VistaPreviaPDF")
	        }
	    }

	    function validarEnvioCartaDocumento() {
	        if (validar()) {
	            console.log("paso validación de validarEnvioCartaDocumento")
	            EnviarCartaDoccumento(this)
	            console.log("se ejecuto EnviarCartaDoccumento")
	        }
	    }
	</script>