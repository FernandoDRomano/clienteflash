...
/*
	...
	var Config = JSON.parse(`
	{
		...
		"Ajax":"` + URLJS + `XMLHttpRequest/Testvalorunico/Ajaxvalorunico.php"//URL De Archivo AjaxPHP Que Se Ejecuta Para Obtener Datos Para Select.
	}`);
...
function ValorDesdeConsulta(Config){//Funcion De Auto Completado De Elemento Genericos
    //console.log("FlameElementosGenericos: ", Config)
