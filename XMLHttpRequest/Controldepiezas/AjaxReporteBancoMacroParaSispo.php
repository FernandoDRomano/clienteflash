<?php
	...
	*/
	...
	if($NumeroDeCargaInterna!=''){
		$Columnas = array("Destinatario","Domicilio","CodigoPostal","Localidad","Barra","Destino","MarcaSistemaFlash","Movimiento");
		$Consulta= "
			SELECT 
				...
				, case
				    when p.CodigoDeMovimiento = 'ALT' then 'ALTA'
				    when p.CodigoDeMovimiento = 'ALTA' then 'ALTA'
				    when p.CodigoDeMovimiento = 'REN' then 'RENOVACION'
				    when p.CodigoDeMovimiento = 'RENO' then 'RENOVACION'
					else ''
				end as 'Movimiento'
